...
<figure class="row img-fluid mx-auto">
<img src="img/moi.png" alt="moi" class="mypicture   rounded-circle mx-auto d-block col-6 col-sm-3 col-md-2 ">
</figure>

<div class="container d-flex justify-content-between">
    <section class="text-center" >
    <h3 class="text-info  font-italic" name="top">Apprenant développeur web chez <u>Simplon</u></h3>
    ...
    <h3 class="text-info font-italic">Mes Compétences Actuel</h3>
